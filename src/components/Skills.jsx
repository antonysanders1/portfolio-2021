    ...
    return (
        <Grid container item xs={12} className={classes.root}>
          ...
          <Grid style={{flex:'1 1 auto', textAlign:'center', marginTop: 80, marginBottom: 80}}>
                <Typography data-aos="fade-up" data-aos-duration="2000"  style={{fontStyle:'italic'}}>"I pride myself on learning new skills and becoming proficient enough <br/> to deliver quailty software to my clients and employers."</Typography>
          </Grid>
        </Grid>
    )
}
